...
import AddScheduleModal from "./AddEventModal_components/AddScheduleModal";
import AddTaskModal from "./AddEventModal_components/AddTaskModal";
...
// イベント追加モーダルコンポーネント
export default function AddEventModal({ setIsEventModalOpen }: { setIsEventModalOpen: (isOpen: boolean) => void }) {
  // イベントの種類（予定またはタスク）を管理するstate
